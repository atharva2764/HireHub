...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .nav-links a {
    color: #fde68a; text-decoration: none; margin-left: 20px;
  ...
  .card-header h1 { font-size: 26px; font-weight: 800; color: #1e293b; }
  .card-header p { color: #64748b; font-size: 14px; margin-top: 6px; line-height: 1.5; }
  ...
  .step-line { width: 32px; height: 2px; background: #e5e7eb; margin: 0 4px; }
  ...
  .bottom-links { text-align: center; font-size: 14px; color: #64748b; }
  .bottom-links a { color: #d97706; font-weight: 700; text-decoration: none; }
...
<div class="main">
  <div class="reset-card">
    ...
    <!-- INFO BOX -->
    <div class="info-box">
      Enter the email address linked to your account along with a new password. Your password will be updated immediately.
    </div>
